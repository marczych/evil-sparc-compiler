...
public class TypeFun implements EVILType {
   ...
   public void setReturnType(EVILType type) {
      mReturn = type;
   }

   public EVILType getReturnType() {
      return mReturn;
   }
   ...
   public String toString() {
      return "mReturn type: "+mReturn+" mParams: "+mParams.toString() +
       " mOrderedParams: "+mOrderedParams.toString()+
       " mLocals: " + mLocals.toString();
   }
}
