...
“The elimination of register saving and restoring makes calling a leaf routine very efficient.” (http://n.ethz.ch/student/ddukaric/zusammenfassungen/Buecher/SPARC%20Architecture.pdf) The SPARC architecture even provides a retl instruction that is the leaf function equivalent to the ret instruction.
